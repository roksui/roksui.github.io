...
Logics are used everyday for representing, computing and reasoning.
...
**NOTE**: We sometimes shorten $tv(F, \alpha)$ and simply write $\alpha(F)$.

So, $tv(F \land G, \alpha) = 1 \leftrightarrow \alpha(F \land G) = 1$.
